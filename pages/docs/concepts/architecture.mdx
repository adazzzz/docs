---
title: Architecture
description: Crossbell is a decentralized platform where many social applications can be built upon, utilizing components such as chains, contracts, protocols, IPFS, and an SDK.
---
