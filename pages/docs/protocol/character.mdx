---
title: Character
description: Crossbell is a social platform that allows users to create and own a unique, sequentially ID'd NFT character, set human-readable handles, and optionally link modules, as well as setting up operator accounts for convenience.
---
