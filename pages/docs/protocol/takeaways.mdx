---
title: Takeaways
description: Crossbell is a platform that enables users to create, own, and transfer characters, notes, and links, with the ability to customize the behavior of each action.
---
