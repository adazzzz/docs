---
title: Read Methods
description: An overview of the read methods available for retrieving character data from the blockchain, including `getCharacter`, `getCharacterByHandle`, `getCharacterUri`, `getHandle`, `getPrimaryCharacterId`, `isPrimaryCharacterId`, `existsCharacterForAddress`, and `existsCharacterForHandle`.
---
