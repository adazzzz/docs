---
title: Mint Note
description: Mint Note is a non-fungible token (NFT) stored on the Crossbell blockchain, which can be minted by wallets (i.e. addresses) and owned by the wallet that minted the note.
---
