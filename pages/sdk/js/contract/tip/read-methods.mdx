---
title: Read Methods
description: The methods used to read $MIRA related data from the blockchain, such as getting the balance of a character or an address, and getting the address and decimals of the $MIRA token contract.
---
