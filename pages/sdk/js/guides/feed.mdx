...
In real-world social media, you can follow other users. In Crossbell, you can follow other characters with [`link.linkCharacter`](https://crossbell-box.github.io/crossbell.js/classes/index.contracts.LinkContract.html#linkCharacter).
