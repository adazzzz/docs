...
The above code will attach a `ApproveMintModule` to the achievement note, which means that only the address `0x1234567890123456789012345678901234567890` can mint the achievement note, and there is a limit of 100 minting.
