...
description: How to use the `indexer` server to query the blockchain and index the data into a database for faster and easier querying, as well as the methods, API and more.
---
